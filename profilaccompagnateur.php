...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/profilaccompagnateur.css" />
    <link rel="stylesheet" type="text/css" href="css/styleguide.css" />
    <link rel="stylesheet" type="text/css" href="css/globals.css" />
  </head>
  <body style="margin: 0; background: #ffffff">
    <input type="hidden" id="anPageName" name="page" value="profilaccompagnateur" />
    <div class="container-center-horizontal">
      <div class="profilaccompagnateur screen">
        <div class="flex-col">
          ...
          <div class="flex-col-1">
            <div class="flex-row-1">
              ...
              <div class="philomena-tiret roboto-medium-black-20-1px">
                <span class="roboto-medium-black-20-1px">Philomena Tiret</span>
              </div>
            </div>
            <div class="flex-row-2">
              ...
              <div class="tag-1">
                <div class="communication-1 montserrat-medium-governor-bay-10px">
                  <span class="montserrat-medium-governor-bay-10px">Photographe</span>
                </div>
              </div>
            </div>
            <div class="tag-2">
              <p class="communication-2 montserrat-medium-governor-bay-10px">
                <span class="montserrat-medium-governor-bay-10px">Expérience en agence: 3 ans</span>
              </p>
            </div>
            <div class="flex-row-3">
              <div class="tag-3">
                <div class="communication-3 montserrat-medium-governor-bay-10px">
                  <span class="montserrat-medium-governor-bay-10px">Escalade</span>
                </div>
              </div>
              <div class="tag-4">
                <div class="communication-4 montserrat-medium-governor-bay-10px">
                  <span class="montserrat-medium-governor-bay-10px">Lecture</span>
                </div>
              </div>
              <div class="tag-5">
                <div class="communication-5 montserrat-medium-governor-bay-10px">
                  <span class="montserrat-medium-governor-bay-10px">Bière</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="flex-col-2">
          <p class="bonjour-moi-cest-p roboto-normal-eerie-black-12px">
            <span class="roboto-normal-eerie-black-12px"
              >Bonjour, moi c’est Philomena, je suis professionnelle de la photographie, j’aime la nature et les bonnes
          ...
          <div class="frame-3323">
            <div class="flex-row-4">
              <div class="flex-col-3">
                <div class="lactivit-de-philomena roboto-bold-eerie-black-12px">
                  <span class="roboto-bold-eerie-black-12px">L’activité de Philomena</span>
                </div>
                <div class="tag-6">
          ...
          <div class="overlap-group1">
            <div class="frame-3322">
              <div class="les-disponnibilits-de-philomena roboto-bold-eerie-black-12px">
                <span class="roboto-bold-eerie-black-12px">Les disponnibilités de Philomena</span>
              </div>

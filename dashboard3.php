...
<body style="margin: 0; background: #ffffff">
  <input type="hidden" id="anPageName" name="page" value="dashboard3" />
  <div class="container-center-horizontal">
    <div class="dashboard3 screen">

      <div class="planning roboto-bold-black-30px"><span class="roboto-bold-black-30px">Planning</span></div>
      ...
      <div class="flex-row">
        ...
        <div class="ajouter-un-rendez-vous roboto-medium-black-16px">
          <span class="roboto-medium-black-16px">Gérez vos rendez-vous</span>
        </div>
      </div>
        ...
        <div class="overlap-group3">
          ...
          <div class="date-default-13 border-1px-silver-chalice">
            <div class="overlap-group">
              <div class="x1-11 valign-text-middle roboto-bold-white-10px">
                <span><span class="roboto-bold-white-10px">29</span> </span>
              </div>
              <img class="vector-25" src="img/vector-25-4@2x.png" />
            </div>
          </div>
          ...
          <div class="date-default-32 border-1px-silver-chalice">
            <div class="overlap-group">
              <div class="x1-30 valign-text-middle roboto-bold-white-10px">
                <span><span class="roboto-bold-white-10px">20</span> </span>
              </div>
              <img class="vector-25" src="img/vector-25-4@2x.png" />
            </div>
          </div>
          ...
          <div class="overlap-group2">
            <div class="ajouter-un-rdv valign-text-middle">
              <span><span>Ajouter un RDV</span> </span>
            </div>
            <img class="vector-14" src="img/vector-14-1@2x.png" />
          </div>
          <div class="tooltip">
            <div class="supprimer-le-rdv valign-text-middle">
              <span><span>Supprimer le&nbsp;&nbsp;RDV</span> </span>
            </div>
            <img class="vector-14-1" src="img/vector-14-2@2x.png" />
          </div>
        </div>
      </div>

      <div class="rectangle-2601"></div>
      <div class="calendrier roboto-medium-black-16px">
        <span class="roboto-medium-black-16px">Votre liste de rendez-vous</span>
      </div>
      ...
      <?php
        ...
        foreach ($res_meeting as $row) {
          ...
          $date=$date_input["weekday"]." ".$date_input["mday"]." ".$date_input["month"];
          $heur=$date_input["hours"]."h".$date_input["minutes"];
      ...
      <div class="frame-3316">
        ...
        <div class="flex-row-1">
          <div class="overlap-grou-1">
            <div class="roboto-medium-oslo-gray-12px">
              <span class="roboto-medium-oslo-gray-12px"><?php echo($heur); ?></span>
            </div>
          </div>
          <div class="overlap-grou-1">
            <div class="x15h30 roboto-medium-oslo-gray-12px">
              <span class="roboto-medium-oslo-gray-12px"><?php echo($res_personne->nom_prenom_pers); ?></span>
            </div>
          </div>
      ...
      <div class="frame-3314">
        ...
        <a href="dashboard2.php">
          <img class="x5_-elements_-navigation-bell-off" src="img/5-elements-navigation-bell-off-5@2x.png" />
        </a>
        <a href="profil4.php">

...
<html>
  ...
  <body style="margin: 0; background: #ffffff">
    <input type="hidden" id="anPageName" name="page" value="profil2" />
    <div class="container-center-horizontal">
      <div class="profil2 screen">
        <div class="flex-col">
        ...
        <div class="flex-row">
          <div class="flex-col-1">
            <div class="flex-row-1">
              ...
              <div class="name roboto-medium-black-20-1px">
                <span class="roboto-medium-black-20-1px">Clara Turio</span>
              </div>
            </div>
            <div class="flex-row-2">
              ...
              <div class="tag-1">
                <div class="communication-1 montserrat-medium-governor-bay-10px">
                  <span class="montserrat-medium-governor-bay-10px">Voyage</span>
                </div>
              </div>
            </div>
            <div class="tag-2">
            ...
            <div class="flex-row-3">
              <div class="tag-3">
                <div class="communication-3 montserrat-medium-governor-bay-10px">
                  <span class="montserrat-medium-governor-bay-10px">Langues</span>
                </div>
              </div>
              <div class="tag-4">
          ...
          <div class="overlap-group2"><img class="avatars" src="img/avatars-14@2x.png" /></div>
        </div>
        <div class="flex-col-2">
          <p class="hello-je-mappelle roboto-normal-eerie-black-12px">
            <span class="roboto-normal-eerie-black-12px"
              >Hello, je m’appelle Clara et j’ai hâte de pouvoir t’apprendre de nouvelles choses ! J’adore les sorties
              entre amis, les voyages et les animaux :)</span
            >
          </p>

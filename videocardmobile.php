...
<html>
  ...
  <body style="margin: 0">
    <input type="hidden" id="anPageName" name="page" value="videocardmobile" />
        ...
        <div class="video-card-mobile">
          <div class="overlap-group">
            ...
            <a href="javascript:HideOverlay('videocardmobile', 'animate-disappear');"
              ><img class="x-symbol" src="img/side-bar-menu-tablet-x-symbol-3C56ADCA-BCBC-41B2-812D-10C244A65ACE.svg" />
            </a>
          </div>
          <div class="flex-row">

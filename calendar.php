...
<head>
    ...
    <style>
        ...
        .recap {
            display: none;
            background: linear-gradient(0deg, rgba(157, 157, 157, 1) 0%, rgba(255, 255, 255, 1) 0%, rgba(246, 246, 246, 1) 77%, rgba(223, 223, 223, 1) 100%);
            padding: 30px;
            margin: 10px;
        }
            ...
            <div class="resume">
                ...
                <div>
                    <ul class="listCreneaux">
                        <li data="08:00:00">8h-10h</li>
                        <li data="10:00:00">10h-12h</li>
                        <li data="14:00:00">14h-16h</li>
                        <li data="16:00:00">16h-18h</li>
                    </ul>
                    <div class="recap">
                        <p>Le <b id="date"></b> de <b id="creneau"></b> autour de la photographie à Centre DuoForm</p>
                        <div align="center">
                            <input class="btnSend" type="button" value="Envoyer Demande">
                        </div>
                    </div>
...
console.log(window.location.hostname);
                    ...
                    var urlString = "sujet="+ <?php echo json_encode($res_pers->domaine); ?> + "&date=" + $datt + "&lieu=lieu"  + "&etudiant=" + <?php echo json_encode($_SESSION['personne']->id); ?> + "&accompagnateur=" + <?php echo json_encode($res_pers->id); ?> + "&action=add";

                    $.ajax({
                        url: "http://"+window.location.hostname+"/duoForm/controllers/meeting.controller.php",
                        type: "POST",
                        cache: false,
                        data: urlString,

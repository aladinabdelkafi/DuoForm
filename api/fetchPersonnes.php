...
if(!empty($_POST["searchterm"])) 
{
    ...
    $sql_query ="SELECT * FROM personne WHERE id_role like '".$_GET['role']."' and (nom_prenom_pers like '%" . $_POST["searchterm"] . "%' or ville like '%" . $_POST["searchterm"] . "%' or  domaine like '%" . $_POST["searchterm"] . "%') 
     ORDER BY nom_prenom_pers";

...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/tablet768signup.css" />
    <style></style>
    <link rel="stylesheet" type="text/css" href="css/styleguide.css" />
    <link rel="stylesheet" type="text/css" href="css/globals.css" />
  </head>
  <body style="margin: 0; background: #ffffff">
    <input type="hidden" id="anPageName" name="page" value="tablet768signup" />
    <div class="container-center-horizontal">
      <div class="desktop1280signup screen">
        <div class="homepage">
          <h1 class="title">Workouts<br />made easy</h1>
          <div class="overlap-group4">
            <img
              class="illustration"
              src="img/desktop-1280---signup-illustration-3410CDA0-6954-4CFA-B45F-22FA1C972A3C@2x.png"
            />
            <div class="sign-up-text-forms">
              <div class="flex-col">
                <div class="start-your-free-trial castoro-regular-normal-black-24px">Start your free trial</div>
                <div class="place castoro-regular-normal-black-16px">Name</div>
                <div class="text-form border-1px-heavy-metal">
                  <input
                    class="text-andrea-baker lato-light-black-16px"
                    name="textandreabaker"
                    placeholder="Andrea Baker"
                    type="text"
                    required
                  />
                </div>
                <div class="password castoro-regular-normal-black-16px">Password</div>
                <div class="text-form-password-desktop border-1px-heavy-metal">
                  <input
                    class="text-password lato-light-black-16px"
                    name="textpassword"
                ...
                <div class="overlap-group">
                  <a href="desktop1280dashboard.html">
                    <div class="cta"><div class="sign-up lato-normal-white-16px">Sign up</div></div></a
                  ><a href="desktop1280dashboard.html">
                    <div class="cta-hover hidden"><div class="sign-up lato-normal-white-16px">Sign up</div></div></a
                  >
                </div>
              </div>
              <div class="flex-col-1 castoro-regular-normal-black-16px">
                <div class="email-address">Email address</div>
                <div class="text-form border-1px-heavy-metal">
                  <input
                    class="text-andrea-bakergmailcom lato-light-black-16px"
                    name="textandreabakergmailcom"
                    placeholder="AndreaBaker@gmail.com"
                    type="email"
                    required
                  />
                </div>
                <div class="confirm-password">Confirm password</div>
                <div class="text-form-confirm-password-desktop border-1px-heavy-metal">
                  <input
                    class="text-confirm-password lato-light-black-16px"
            ...
            <div class="subtitle lato-light-black-18px">
              Let’s be honest, it’s hard to fit working out into our busy schedule.<br />With Trainerz you do less work
              and see more results. 20 minutes<br />a day, 5 times a week, and you’ll hit your fitness goal, easily.
            </div>
            <div class="pulsing-dot">
              <div class="overlap-group1">
                <div class="pulsingdot1 component component-wrapper not-ready">
                  <img
                    class="oval-xzAkKP"
                ...
                <script defer>
                  document.querySelector(".pulsingdot1.component-wrapper").timeline_data = [
                    {
                      initial_state_name: "state1",
                      root_element: ".pulsingdot1",
                      states_flow: {
                        state1: {
                          listeners: [
                            {
                ...
                <div class="bubble-hover hidden">
                  <div class="group"><div class="feature-here caveat-regular-normal-rose-21px">Next screen</div></div>
                </div>
              </div>
            </div>
            <div class="tour-bubble-right">
              <div class="overlap-group2">
                <div class="pulsingdot12 component component-wrapper not-ready">
                  <img
                    class="oval-CKbvIy"
                    src="img/desktop-1280---dashboard--oval-9151214D-71FA-42DB-AFE1-2CF04E8799E3@4x.png"
                  />
                ...
                <script defer>
                  document.querySelector(".pulsingdot12.component-wrapper").timeline_data = [
                    {
                      initial_state_name: "state1",
                      root_element: ".pulsingdot12",
                      states_flow: {
                        state1: {
                          listeners: [
                            {
                ...
                <div class="bubble-hover-1 hidden">
                  <div class="group-1">
                    <div class="feature-here caveat-regular-normal-rose-21px">
                      This is a live form (and yes, you can collect the data)
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div class="tour-bubble-right-copy">
              <div class="overlap-group3">
                <div class="pulsingdot13 component component-wrapper not-ready">
                  <img
                    class="oval-7xEhrw"
                    src="img/desktop-1280---dashboard--oval-9151214D-71FA-42DB-AFE1-2CF04E8799E3@4x.png"
                  />
                ...
                <script defer>
                  document.querySelector(".pulsingdot13.component-wrapper").timeline_data = [
                    {
                      initial_state_name: "state1",
                      root_element: ".pulsingdot13",
                      states_flow: {
                        state1: {
                          listeners: [
                            {
                ...
                <div class="bubble-hover-2 hidden">
                  <div class="group-2">
                    <div class="feature-here caveat-regular-normal-rose-21px">when it&#39;s a password, we 🙈</div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container-center-horizontal">
      <div class="tablet768signup screen">
        <div class="homepage-2">
          <div class="title-2">Workouts<br />made easy</div>
          <div class="overlap-group-1">
            <img class="image-1" src="img/tablet-768----signup-image-FD92E4C8-A799-476E-AB8A-8E5BA2E1E61D@2x.png" />
            <p class="subtitle-2 lato-light-black-16px">
              Let’s be honest, it’s hard to fit working out into our busy schedule.<br />With Trainerz you do less work
              and see more results. 20 minutes a day, 5 times a week, and you’ll hit your fitness goal, easily.
            </p>
          </div>
          <div class="sign-up-text-forms-2">
            <div class="flex-col-2">
              <div class="start-your-free-trial-2 castoro-regular-normal-black-24px">Start your free trial</div>
              <div class="place-2 castoro-regular-normal-black-16px">Name</div>
              <div class="text-form-name-tablet border-1px-heavy-metal">
                <input
                  class="text-andrea-baker-2 lato-light-black-16px"
                  name="textandreabaker"
                  placeholder="Andrea Baker"
                  type="text"
                  required
              ...
              <div class="password-1 castoro-regular-normal-black-16px">Password</div>
              <div class="text-form-1 border-1px-heavy-metal">
                <input
                  class="text-password-1 lato-light-black-16px"
                  name="textpassword"
                  placeholder="Password"
                  type="password"
                  required
              ...
              <a href="tablet768dashboard.html">
                <div class="cta-2"><div class="sign-up-2 lato-normal-white-16px">Sign up</div></div></a
              >
            </div>
            <div class="flex-col-3 castoro-regular-normal-black-16px">
              <div class="email-address-1">Email address</div>
              <div class="text-form-1 border-1px-heavy-metal">
                <input
                  class="text-andrea-bakergmailcom-2 lato-light-black-16px"
                  name="textandreabakergmailcom"
                  placeholder="Andrea-baker@gmail.com"
                  type="email"
                  required
                />
              </div>
              <div class="password-1">Confirm password</div>
              <div class="text-form-confirm-password-tablet border-1px-heavy-metal">
                <input
                  class="text-confirm-password-1 lato-light-black-16px"
                  name="textconfirmpassword"
                  placeholder="Confirm password"
                  type="password"
                  required
    ...
    <div class="container-center-horizontal">
      <div class="mobile375signup screen">
        <div class="homepage-1">
          <div class="title-1">Workouts<br />made easy</div>
          <p class="subtitle-1">
            Let’s be honest, it’s hard to fit working out into our busy schedule. With Trainerz you do less work and see
            more results. 20 minutes a day, 5 times a week, and you’ll hit your fitness goal, easily.
          </p>
          <img class="image" src="img/mobile-375---signup-image-875F2384-747F-4D7E-9827-D8413AE47783@2x.png" />
          <div class="sign-up-text-forms-1">
            <div class="start-your-free-trial-1 castoro-regular-normal-black-24px">Start your free trial</div>
            <div class="place-1 castoro-regular-normal-black-16px">Name</div>
            <div class="text-form-name-mobile border-1px-heavy-metal">
              <input
                class="text-andrea-baker-1 lato-light-black-16px"
                name="textandreabaker"
                placeholder="Andrea Baker"
                type="text"
                required
            ...
            <div class="sign-up-text-forms-item castoro-regular-normal-black-16px">Email address</div>
            <div class="text-forms-email-mobile border-1px-heavy-metal">
              <input
                class="text-andrea-bakergmailcom-1 lato-light-black-16px"
                name="textandreabakergmailcom"
                placeholder="Andrea-baker@gmail.com"
                type="email"
                required
            ...
            <div class="sign-up-text-forms-item castoro-regular-normal-black-16px">Password</div>
            <div class="text-forms border-1px-heavy-metal">
              <input
                class="text lato-light-black-16px"
                name="textpassword"
                placeholder="Password"
                type="password"
                required
            ...
            <div class="sign-up-text-forms-item castoro-regular-normal-black-16px">Confirm password</div>
            <div class="text-forms border-1px-heavy-metal">
              <input
                class="text lato-light-black-16px"
                name="textconfirmpassword"
            ...
            <a href="mobile375dashboard.html">
              <div class="cta-1 border-1px-heavy-metal">
                <div class="sign-up-1 lato-normal-white-16px">Sign up</div>
              </div></a
            >
          </div>
        </div>

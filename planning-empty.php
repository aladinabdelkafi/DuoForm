...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/planning-empty.css" />
    <link rel="stylesheet" type="text/css" href="css/styleguide.css" />
    <link rel="stylesheet" type="text/css" href="css/globals.css" />
  </head>
  <body style="margin: 0; background: #ffffff">
    <input type="hidden" id="anPageName" name="page" value="planning-empty" />
    <div class="container-center-horizontal">
      <div class="planning-empty screen">
        ...
        <div class="overlap-group1">
          <div class="pas-de-rendez-vous-prvu"><span>Pas de rendez-vous prévu</span></div>
        </div>
        ...
        <div class="group-16">
          <div class="date-default-container">
            ...
            <div class="date-default-10 border-1px-silver-chalice">
              <div class="x1-8 valign-text-middle roboto-normal-black-10px">
                <span><span class="roboto-normal-black-10px">15</span> </span>
              </div>
            </div>
            ...
            <div class="date-default-29 border-1px-silver-chalice">
              <div class="x1-27 valign-text-middle roboto-normal-black-10px">
                <span><span class="roboto-normal-black-10px">12</span> </span>
              </div>
            </div>

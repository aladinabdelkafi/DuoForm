...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/sinscrire4.css" />
    <link rel="stylesheet" type="text/css" href="css/styleguide.css" />
    <link rel="stylesheet" type="text/css" href="css/globals.css" />
  </head>
  <body style="margin: 0; background: #ffffff">
    <input type="hidden" id="anPageName" name="page" value="sinscrire4" />
    <div class="container-center-horizontal">
      <div class="sinscrire4 screen">
        <div class="overlap-group">
          <div class="background"></div>

          <form method="post" action="sinscrireProf6.php">
          ...
          <div class="text-16 roboto-normal-oslo-gray-15px">
            <span>Bac +</span>
            <input class="roboto-normal-oslo-gray-15px" type="text" name="nivEtudProf" pattern="[0-9]{2}" placeholder="0" size="1" title="Chiffre entre 0 et 9">
          </div>
          <div class="tlphone roboto-medium-black-16px"><span class="roboto-medium-black-16px">Quelle est votre niveau d’étude ?</span></div>

          <p class="quelle-est-votre-domaine-dtudes roboto-medium-black-16px">
            <span class="roboto-medium-black-16px">Dans quel(s) domaine(s) ?</span>
          </p>
          
          <p class="je-recherche-un-accompagnateur-dans roboto-medium-black-16px">
          <span class="roboto-medium-black-16px">Avez-vous d’autre(s) domaine(s) que vous souhaitez transmettre?</span>
        </p>
